...
const createUser = () => {
    let userData_personalData_name = createConnectData('Name','Eckert')
    let userData_personalData_surname = createConnectData('Vorname','Lena')
    let userData_personalData_phone = createConnectData('Handy','2341234 12341234')
    let userData_personalData_image = createConnectData('Image',lena)
    let userData_hashTagData_color = createConnectData('Wohnort','Dresden')
    let userData_hashTagData_hobby = createConnectData('Beruf','Dozent, Vwl')
    ...
    publicSharedData_socialData.push(userData_socialData_linkedIn)
...
const lena_user = createUser()
export default lena_user
